        ...
        <Card title="Head-to-head" subtitle="Compare any two players · swap to add a different one" icon="users">
          ...
          <HeadToHead
            ...
            rows={[
              ...
              { label: "High-speed running (m)", a: pa.hsr_m ?? 0, b: pb.hsr_m ?? 0, fmt: (n) => Math.round(n).toString() },
              { label: "Accelerations", a: pa.accelerations ?? 0, b: pb.accelerations ?? 0 },
              { label: "Decelerations", a: pa.decelerations ?? 0, b: pb.decelerations ?? 0 },
