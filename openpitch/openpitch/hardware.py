...
PACKAGES: dict[str, dict] = {
    "starter": {
        ...
        "capture": [
            ...
            {"name": "Camera G5 Bullet", "model": "UVC-G5-Bullet", "qty": 1,
             "role": "Endline"},
            {"name": "U7 Pro Outdoor AP", "model": "U7-Pro-Outdoor", "qty": 1,
             "role": "Pitch-side WiFi 7 — weatherproof PoE+ backhaul for cameras + sync agent"},
        ],
    },
    "growth": {
        "name": "Growth",
    ...
    "pro": {
        ...
        "capture": [
            ...
            {"name": "Camera G5 Bullet", "model": "UVC-G5-Bullet", "qty": 1,
             "role": "Endline"},
            {"name": "U7 Pro Outdoor AP", "model": "U7-Pro-Outdoor", "qty": 2,
             "role": "Pitch-side WiFi 7 — weatherproof PoE+ backhaul for cameras + sync agent"},
            {"name": "Indoor AP", "model": "U7-Pro", "qty": 1,
             "role": "Clubhouse WiFi"},
        ],
